...
plot_bar(phyloseq_object, x = "Sample", y = "Abundance", fill ="phylum") + 
  geom_bar(aes(color=phylum, fill=phylum), stat="identity", position="stack")+
  theme_classic()+
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))

plot_bar(phyloseq_object, x = "sample_type", y = "Abundance", fill ="phylum") + 
  geom_bar(aes(color=phylum, fill=phylum), stat="identity", position="stack")+
  theme_classic()

plot_bar(phylo_object_no_incertae, x = "Sample", y = "Abundance", fill ="phylum") + geom_bar(aes(color=phylum, fill=phylum), stat="identity", position="stack")

plot_bar(phylo_object_no_incertae, x = "sample_type", y = "Abundance", fill ="phylum") + geom_bar(aes(color=phylum, fill=phylum), stat="identity", position="stack")
```
